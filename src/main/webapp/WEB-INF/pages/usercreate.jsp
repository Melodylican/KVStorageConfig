						...
						<div class="span12">
							...
							<div class="widget-box">
								...
								<div class="widget-content nopadding">
									<form action="<%=request.getContextPath()%>/user/savecreate" method="post" class="form-horizontal" name="basic_validate" id="basic_validate" >
									   <div class="control-group">
											<label class="control-label">账号</label>
											<div class="controls">
												<input type="text" name="userName" id="userName" value="${userBean.userName }" placeholder="输入用户名" class="span5">
											</div>
										</div>
										<div class="control-group">
											<label class="control-label">密码</label>
											<div class="controls">
												<input type="text" name="password" id="password" value="${userBean.password }" placeholder="输入密码" class="span5">
											</div>
										</div>
										<div class="control-group">
										...
										<div class="control-group">
											<label class="control-label">用有权限的游戏</label>
											<div class="controls">
												<select multiple class="span5" name="gameType">
												<!-- 此处显示当前系统中已经拥有的游戏 -->
													<c:forEach items="${gameList}" var="nameList">
									                         <option value="${nameList.gameName}">${nameList.gameName}</option>
									                </c:forEach>
									             <!-- 显示游戏选项结束 -->   
												</select>
											</div>
