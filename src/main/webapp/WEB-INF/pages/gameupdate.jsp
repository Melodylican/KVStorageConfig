...
<body>
	...
	<div id="sidebar">
		...
		<c:if test="${pageContext.request.isUserInRole('ROLE_SUPER_ADMIN')}">
			...
			<li class="active"><a href="<%=request.getContextPath()%>/game/game"> <i class="icon icon-tint"></i> <span>游戏管理</span> </a></li>
        </c:if>
        </ul>
	</div>
	<!--sidebar-menu-->
						...
						<div class="span12">
							...
							<div class="widget-box">
								...
								<div class="widget-content nopadding">
									<form action="<%=request.getContextPath()%>/game/saveupdate" method="post" class="form-horizontal" name="basic_validate" id="basic_validate">
